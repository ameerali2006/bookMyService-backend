...
const base_repository_1 = require("../../repository/shared/base.repository");
...
let AddressRepository = class AddressRepository extends base_repository_1.BaseRepository {
    ...
    findByUserId(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield address_model_1.AddressModel.find({ userId });
        });
    }
    findPrimaryByUserId(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield address_model_1.AddressModel.findOne({ userId, isPrimary: true });
        });
    }
    findByLabel(userId, label) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield address_model_1.AddressModel.findOne({ userId, label });
        });
    }
};
