...
let ReviewController = class ReviewController {
    ...
    addReview(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.reviewService.addReview(comment, rating, bookingId, userId);
                console.log(result);
    ...
    allReviewManagement(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { search = '', sort = 'latest', page = '1', limit = '10', } = req.query;
                const result = yield this.reviewService.getAllReviews({
...
exports.ReviewController = ReviewController = __decorate([
    ...
    __param(0, (0, tsyringe_1.inject)(types_1.TYPES.ReviewService)),
