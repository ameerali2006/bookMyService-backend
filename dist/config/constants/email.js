...
const SERVICE_REJECTED_MAIL_CONTENT = (userName, serviceName, reason, refundAmount) => {
...
exports.SERVICE_REJECTED_MAIL_CONTENT = SERVICE_REJECTED_MAIL_CONTENT;
...
const SENT_REJECTION_EMAIL = (entityLabel, reason, retryUrl) => `
